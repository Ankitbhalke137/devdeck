...
function JsonTab() {
  ...
  return (
    <div className="h-full flex flex-col p-3 space-y-2">
      ...
      {output && <CopyButton label="Copy" copied={copied} onClick={copyOutput} />}
    </div>
  );
}
  ...
  return (
    <div className="h-full flex flex-col p-3 space-y-2">
      ...
      <button
        ...
        className="px-3 py-1.5 text-xs text-secondary bg-surface-2 hover:bg-surface-3 rounded border border-custom transition-colors self-start"
      >
        Decode
      </button>
    ...
    <div className="h-full flex flex-col p-3 space-y-2">
      ...
      <div className="flex-1 bg-surface-2 border border-custom rounded p-2 overflow-auto">
        ...
        {matches.length > 0 ? (
          ...
          <div className="text-muted text-xs">No matches found</div>
        )}
      </div>
    </div>
  );
